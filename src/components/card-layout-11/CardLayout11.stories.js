// Story for CardLayout11 Web Component

const defaultCardData = {
  first_name: 'John', last_name: 'Doe', designation: 'Software Engineer', company: 'Tech Corp',
  summary: 'Passionate software engineer with 5+ years of experience building innovative solutions.',
  email_v2: [{ value: 'john@techcorp.com', label: 'Work' }],
  phone_v2: [{ value: '+1 (555) 123-4567', label: 'Mobile' }],
  website_v2: [{ value: 'https://johndoe.dev', label: 'Portfolio' }],
  social_links: { linkedin: 'https://linkedin.com/in/johndoe', twitter: 'https://twitter.com/johndoe', instagram: 'https://instagram.com/johndoe' },
  customizations: {
...
const Template = (args) => {
  ...
  const webComponent = document.createElement('uniqode-layout-11');
...
export default {
  title: 'Components/CardLayout11',
  component: 'uniqode-layout-11',
  parameters: { docs: { description: { component: 'Card Layout 11 - Premium card with contact grid' } } },
