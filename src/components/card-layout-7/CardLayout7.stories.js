// Story for CardLayout7 Web Component
...
const Template = (args) => {
  ...
  const webComponent = document.createElement('uniqode-layout-7');
...
export default {
  title: 'Components/CardLayout7',
  component: 'uniqode-layout-7',
  parameters: {
    docs: {
      description: {
        component: 'Card Layout 7 - Simple centered card design',
      },
    },
  },
  argTypes: {
    cardData: { control: 'object', description: 'Card data object' },
  },
};
