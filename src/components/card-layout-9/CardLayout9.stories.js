// Story for CardLayout9 Web Component

const defaultCardData = {
  first_name: 'John', last_name: 'Doe', designation: 'Software Engineer', company: 'Tech Corp',
  summary: 'Passionate software engineer with 5+ years of experience building scalable applications.',
  ...
  social_links: { linkedin: 'https://linkedin.com/in/johndoe', twitter: 'https://twitter.com/johndoe', github: 'https://github.com/johndoe' },
  customizations: {
...
const Template = (args) => {
  ...
  const webComponent = document.createElement('uniqode-layout-9');
...
export default {
  title: 'Components/CardLayout9',
  component: 'uniqode-layout-9',
  parameters: { docs: { description: { component: 'Card Layout 9 - Sectioned card with social focus' } } },
